# Production backend infra for Stima.
# Provisions network/VM/IAM and renders startup config template.
# Contract: required logging/monitoring scopes are always enforced for the VM service account.
locals {
