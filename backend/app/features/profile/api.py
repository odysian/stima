...
async def update_profile(
    ...
    try:
        profile = await profile_service.update_profile(
            ...
            update_phone_number="phone_number" in payload.model_fields_set,
            business_address_line1=payload.business_address_line1,
            update_business_address_line1="business_address_line1" in payload.model_fields_set,
            business_address_line2=payload.business_address_line2,
            update_business_address_line2="business_address_line2" in payload.model_fields_set,
            business_city=payload.business_city,
            update_business_city="business_city" in payload.model_fields_set,
            business_state=payload.business_state,
            update_business_state="business_state" in payload.model_fields_set,
            business_postal_code=payload.business_postal_code,
            update_business_postal_code="business_postal_code" in payload.model_fields_set,
