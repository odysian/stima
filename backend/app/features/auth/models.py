...
class User(Base):
    ...
    business_address_line1: Mapped[str | None] = mapped_column(sa.String(255), nullable=True)
    business_address_line2: Mapped[str | None] = mapped_column(sa.String(255), nullable=True)
    business_city: Mapped[str | None] = mapped_column(sa.String(100), nullable=True)
    business_state: Mapped[str | None] = mapped_column(sa.String(64), nullable=True)
    business_postal_code: Mapped[str | None] = mapped_column(sa.String(20), nullable=True)
